...
public:
    ...
    void            load_presets(AppConfig &config, AllFilesConfigSubstitutions& substitutions, ForwardCompatibilitySubstitutionRule rule, const std::string &preferred_model_id = "");
