...
if(_CXX_FILESYSTEM_HAVE_HEADER)
    ...
    set(_fs_is_experimental FALSE)
elseif(_CXX_FILESYSTEM_HAVE_EXPERIMENTAL_HEADER)
    set(_have_fs TRUE)
    set(_fs_header experimental/filesystem)
    set(_fs_namespace std::experimental::filesystem)
    set(_fs_is_experimental TRUE)
else()
    set(_have_fs FALSE)
endif()
...
set(CXX_FILESYSTEM_IS_EXPERIMENTAL ${_fs_is_experimental} CACHE STRING "The C++ namespace that contains the filesystem APIs")
...
if(CXX_FILESYSTEM_HAVE_FS)
    ...
    if(can_link)
        ...
        if (CXX_FILESYSTEM_IS_EXPERIMENTAL)
            target_compile_definitions(std_filesystem INTERFACE CXX_FILESYSTEM_IS_EXPERIMENTAL)
        endif()
